...
export default function BottomPanel() {
  const { buses, filterText, activeBus, setActiveBus } = useApp();
  ...
  return (
    <div className="absolute z-[900] top-3 sm:top-4 right-3 sm:right-4 bottom-3 sm:bottom-4 w-[calc(100vw-1.5rem)] sm:w-[360px] flex">
